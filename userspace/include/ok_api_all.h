...
OK_RESULT Ok_Load_User_Aes(struct OK_CONTEXT * ok_context, char *filename, OK_KEY *handle);
OK_RESULT Ok_Encrypt_User_Data_By_Aes(struct OK_CONTEXT * ok_context, unsigned char *in, unsigned int inlen,
        unsigned char * out, unsigned int *outlen, OK_KEY handle);
